...
| :--------------------------------------------------- | :-------------------------------------------------------------------------------- | :-------- | :----------------------------------------------------------------------------------------------------- |
| **Plugin SDK & Extensibility**                       | [Heretek-Games/drop-plugin-sdk](https://github.com/Heretek-Games/drop-plugin-sdk) | M1        | Official `@droposs/plugin-sdk`, `drop-plugin` build/sign toolchain, and plugin runtime contracts.      |
