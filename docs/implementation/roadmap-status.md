...
| #19 Dropworks SDK & Multiplayer    | 🟡     | Server REST contract (`/api/v1/dropworks/session`, `/achievement`, `/leaderboard`, `/presence`) with token-derived users, leaderboard best-score retention and presence wired to the local presence service ✅; TypeScript reference client + Rust binding + a tested C ABI (`libdropworks`, C smoke test) + a C# P/Invoke binding (buildable smoke test) covering session/achievement/leaderboard/presence ✅; WebRTC/ICE NAT traversal and the GDScript wrapper remain ⛔.                                                                                                                                                                                                                                                                                                                                                  |
