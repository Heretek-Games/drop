...
| :--------------------------------- | :----- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| #17 Content delivery               | ✅     | `downpour push` CDC chunker + zstd + memory/S3 upload; torrential LAN registry, SSDP discovery, HTTP chunk fetcher with peer-chunk SHA-256 verification (`verify_chunk_sha256` / `fetch_verified_from_best_peer`); shader-cache discovery + `drop-gamebox` index; PCGamingWiki externalized. QUIC is contract-only and deferred: `torrential/src/lan/mod.rs` defines the `ChunkFetcher` trait, HTTP is the implemented transport. |
